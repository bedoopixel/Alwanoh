...
class DiscountSlider extends StatefulWidget {
  ...
  @override
  _DiscountSlider createState() => _DiscountSlider();
}

class _DiscountSlider extends State<DiscountSlider> {
  @override
        ...
        return StreamBuilder(
          ...
          builder: (context, AsyncSnapshot<QuerySnapshot> honeySnapshot) {
            ...
            final filteredProducts = allProducts.where((product) {
              ...
              final isNew = product['isOnOffer'] as bool? ?? false;
