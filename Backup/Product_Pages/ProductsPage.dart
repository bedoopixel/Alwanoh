...
class _ProductsPageState extends State<ProductsPage> {
  ...
  void initState() {
    ...
    if (context.read<UserProvider>().userId != null) {
      _loadFavoriteStates(context.read<UserProvider>().userId!);
    }
  }

  Future<void> _loadFavoriteStates(String userId) async {
    ...
    setState(() {
      favoriteStates = {
        for (var doc in favoritesSnapshot.docs) doc.id: true,
      };
    });
  }
  ...
  Widget _buildProductCard(Map<String, dynamic> product) {
    ...
    return FutureBuilder<bool>(
      ...
      builder: (context, snapshot) {
        ...
        favoriteStates[product['id']] = snapshot.data ?? false;
                    ...
                    Positioned(
                      ...
                      child: Builder(
                        builder: (context) {
                          ...
                          final isFavorite = favoriteStates[productId] ?? false;
                          ...
                          return IconButton(
                            ...
                            onPressed: () async {
                              ...
                              setState(() {
                                favoriteStates[productId] = newFavoriteState;
                              });

                              if (newFavoriteState) {
                                await _addToFavorites(userId!, productId, product);
                              } else {
                                await _removeFromFavorites(userId!, productId);
                              }
                            },
                          );
                        },
